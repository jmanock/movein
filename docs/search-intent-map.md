...
| Intent | Primary route | Supporting routes | Outcome |
|---|---|---|---|
| Find utilities by ZIP | `/` | `/learn-your-area`, `/coverage` | Enter ZIP and understand address confirmation |
| Local provider evidence | `/lookup/[zip]` | guides, corrections, data sources | Review possibilities and continue officially |
