...
The front end targets WCAG 2.2 AA fundamentals: semantic landmarks, one H1 on representative pages, visible labels, native controls, skip link, visible `:focus-visible`, 44px mobile menu target, text contrast, image alternatives, and reduced-motion support.
