...
export function SiteChrome({ children }: { children: React.ReactNode }) {
  ...
  return <>
    ...
    {children}
    <footer><div className="shell footer-grid"><div><Brand /><p>Find possible utility and local-service providers, then confirm your exact address with the official source.</p></div><div><h2>Explore</h2><Link href="/homeowners">Homeowners</Link><Link href="/renters">Renters</Link><Link href="/learn-your-area">Learn Your Area</Link><Link href="/resources">Resources</Link><Link href="/faq">FAQ</Link></div><div><h2>Trust</h2><Link href="/data-sources">Data Sources</Link><Link href="/corrections">Corrections</Link><Link href="/editorial-policy">Editorial Policy</Link><Link href="/privacy">Privacy</Link><Link href="/terms">Terms</Link></div><div><h2>MoveIn</h2><Link href="/about">About</Link><Link href="/contact">Contact</Link><Link href="/disclosure">Disclosure</Link><p>Not a utility company or government agency.</p></div></div><div className="shell footer-bottom"><span>© {new Date().getFullYear()} MoveIn</span><span>Coverage is limited to a five-county Florida pilot.</span></div></footer>
  </>;
}
