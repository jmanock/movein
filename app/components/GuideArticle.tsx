...
const myMoveActions: Record<string, { taskId: string; label: string }> = {
  ...
  "/renters/renters-insurance-and-deposits": { taskId: "condition-photos", label: "Add renter documentation to My Move" },
