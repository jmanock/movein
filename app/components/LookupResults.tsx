...
function statusLabel(status: LookupResult["status"]) { return status === "verified" ? "Verified" : status === "partial" ? "Partial" : "Verification in progress"; }
