...
export function LookupResults({ result, relatedAreas = [] }: { result: LookupResult; relatedAreas?: RelatedArea[] }) {
  ...
  return <>
    ...
    <section className="recently-moved"><div className="section-heading compact"><span className="eyebrow">Recently moved?</span><h2>Finish the practical local updates.</h2><p>These links go directly to government, library, emergency, or utility sources. Eligibility and deadlines depend on your circumstances, so review the official instructions.</p></div><LocalResourceCards resources={recentlyMoved} /></section>
