...
export function LookupResults({ result, relatedAreas = [] }: { result: LookupResult; relatedAreas?: RelatedArea[] }) {
  ...
  return <>
    ...
    <section className="people-also-need"><div className="section-heading compact"><span className="eyebrow">Practical next steps</span><h2>People moving to this ZIP also need:</h2></div><div><Link href="/resources/find-electric-company">Set up electricity</Link><Link href="/resources/find-water-provider">Confirm water and sewer</Link><Link href="/resources/check-internet-availability">Check internet availability</Link><Link href="/resources/find-trash-service">Find trash and recycling</Link><Link href="/resources/printables/address-update-checklist">Use the address-update checklist</Link><Link href="/resources/printables/outage-emergency-numbers">Save outage and emergency numbers</Link></div><AddToMyMoveButton taskId="local-utilities" label="Add local utility setup to My Move" sourcePage="/lookup/[zip]" /></section>
