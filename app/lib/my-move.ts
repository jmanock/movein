...
export const moveTasks: MoveTask[] = [
  ...
  { id: "renter-lease-utilities", title: "Mark which utilities the lease assigns to you", description: "Confirm included services, tenant accounts, billing methods, and any shared-meter allocation in writing.", phase: "Before the move", category: "utilities", audience: "renter", href: "/renters/what-utilities-do-renters-pay" },
  { id: "renter-move-budget", title: "Plan the full renter move-in budget", description: "Use written property, provider, insurer, and moving amounts; keep payment details private.", phase: "Before the move", category: "budget", audience: "renter", href: "/renters/move-in-cost-calculator" },
  { id: "renter-financial-setup", title: "Save insurance, deposit, and move-in fee records", description: "Keep the lease, receipts, coverage documents, and official notices together privately.", phase: "Before the move", category: "records", audience: "renter", href: "/renters/renters-insurance-and-deposits" },
  { id: "renter-lease-copy", title: "Save a complete signed lease copy privately", phase: "Before the move", category: "records", audience: "renter", href: "/renters/questions-before-signing-a-lease" },
  ...
  { id: "renter-inspection-form", title: "Submit the move-in condition form by the required method", phase: "Move-in day", category: "documentation", audience: "renter", href: "/renters/document-move-in-condition" },
  { id: "renter-payment-receipt", title: "Save move-in payment receipts privately", phase: "Move-in day", category: "records", audience: "renter", href: "/renters/move-in-costs" },
  { id: "renter-correspondence", title: "Save property-management notices and responses privately", phase: "First week", category: "records", audience: "renter", href: "/renters/renters-insurance-and-deposits" },
