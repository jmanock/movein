...
export default async function RenterGuidePage({ params }: { params: Promise<{ slug: string }> }) { const { slug } = await params; const guide = getGuide("renters", slug); if (!guide) notFound(); return <GuideArticle guide={guide} />; }
