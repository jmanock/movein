...
export const metadata: Metadata = pageMetadata("My Move Timeline", "A practical move-in checklist organized from before move-in through the first year.", "/timeline", "/og/timeline");
