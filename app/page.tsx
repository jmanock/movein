...
export default function HomePage() {
  ...
  return <main id="main-content"><JsonLd data={structuredData} />
    ...
    <section className="section"><div className="shell home-retention"><div><span className="eyebrow">Your move, one useful step at a time</span><h2>Turn these guides into a checklist that remembers.</h2><p>My Move adapts to your date, ZIP, and homeowner or renter path. No account or email. Progress stays in this browser.</p><div><Link className="button" href="/my-move">Build My Move <ArrowRight size={16} aria-hidden="true" /></Link><Link href="/first-30-days">Explore the first 30 days</Link></div></div><DontForget sourcePage="/" /></div></section>
