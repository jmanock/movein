...
export const metadata: Metadata = pageMetadata("Find Your Florida Utility Providers by ZIP Code", DEFAULT_DESCRIPTION, "/");
...
export default function HomePage() {
  return <main id="main-content"><JsonLd data={structuredData} />
    <section className="lookup-hero"><div className="shell hero-content"><span className="eyebrow">Florida utility lookup</span><h1>Find the services for your new place.</h1><p>Enter a Florida ZIP code to find local electric, water, internet, and other essential providers.</p><ZipLookupForm /><div className="pilot-note"><CheckCircle2 size={18} aria-hidden="true" /><span>Pilot coverage: {pilotCounties.join(", ")} counties. Results may require address confirmation.</span></div></div></section>
