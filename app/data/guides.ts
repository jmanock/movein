...
const spectrumMoving: OfficialResource = { title: "Move Spectrum Service", organization: "Spectrum", url: "https://www.spectrum.com/moving", checked: "2026-08-20", note: "Official Spectrum moving guidance, address check, equipment, and installation starting point." };
const attMoving: OfficialResource = { title: "Transfer, Set Up, or Move AT&T Service", organization: "AT&T", url: "https://www.att.com/help/moving/", checked: "2026-08-20", note: "Official AT&T flow for checking the new address and reviewing transfer or new-service options." };
const tMobileMoving: OfficialResource = { title: "Transfer T-Mobile Home Internet", organization: "T-Mobile", url: "https://www.t-mobile.com/home-internet/transfer-internet-service", checked: "2026-08-20", note: "Official eligibility, service-location, gateway, and moving guidance for T-Mobile Home Internet." };
const verizonMoving: OfficialResource = { title: "Move Verizon Home Internet", organization: "Verizon", url: "https://www.verizon.com/home/internet/moving/", checked: "2026-08-20", note: "Official Verizon new-address availability and Home Internet moving guidance." };
const xfinityMoving: OfficialResource = { title: "Transfer Xfinity Services When You Move", organization: "Xfinity (Comcast)", url: "https://www.xfinity.com/support/articles/transferring-service-to-a-new-location", checked: "2026-08-20", note: "Official Xfinity guidance for address eligibility, equipment, activation, installation, and service transfer. MoveIn does not currently publish Xfinity as a verified pilot provider." };
...
export const guides: Guide[] = [
  ...
  },
  {
    ...
    title: "Transfer Internet When Moving: A Checklist", description: "Check your current Internet provider at the new address, compare alternatives, schedule service, test it, and return old equipment when required.",
    h1: "How to transfer internet service when moving", eyebrow: "Internet move planning",
    directAnswer: "Check whether your current provider serves the complete new address, then compare alternatives before automatically transferring. Schedule activation or installation, keep old service until moving day when practical, test the new connection, return equipment as instructed, and cancel the old account only when appropriate.",
    published: "2026-08-07", reviewed: "2026-08-20",
    sections: [
      { heading: "1. Check the current provider at the new address", paragraphs: ["Being an existing customer does not mean the same provider, connection technology, speed tier, or account terms are available after the move."], steps: ["Run the provider's official checker for the complete new address and unit.", "Confirm the connection technology that is actually orderable.", "Ask whether the existing account, plan, and equipment can transfer.", "Save the result privately before changing the old account."] },
      { heading: "2. Compare alternatives before transferring automatically", paragraphs: ["A move is a useful comparison point because the available networks can change. Review wired and wireless possibilities without assuming a familiar provider is the only choice."], steps: ["Use MoveIn to compare possible providers for the new ZIP.", "Check each serious option at the exact address.", "Compare technology, regular terms, equipment, installation, and support.", "Choose based on the new address rather than the old provider relationship."] },
      { heading: "3. Schedule activation or installation", paragraphs: ["Appointment and delivery timing varies by provider, property, and current workload. Ask for the actual available date instead of relying on a universal moving deadline."], steps: ["Confirm whether self-installation, equipment delivery, or a technician is required.", "Get landlord, property-manager, or HOA approval before physical changes.", "Confirm unit access, wiring, and technician entry.", "Keep the appointment and order details privately."] },
      { heading: "4. Coordinate old and new service dates", paragraphs: ["Some households need a short overlap for remote work, school, cameras, or property access. Others can stop the old connection once the new activation is confirmed."], steps: ["Keep old service through moving day when practical and useful.", "Avoid paying for a long overlap the household does not need.", "Do not cancel before the new order and access plan are confirmed.", "Record both service dates and confirmations privately."] },
      { heading: "5. Confirm the equipment plan", paragraphs: ["Ask whether to move, exchange, or return the modem, gateway, router, power supply, cables, and other rented equipment. Do not assume equipment that worked at the old address is compatible at the new one."] },
      { heading: "6. Test the new connection", paragraphs: ["After activation, confirm that the ordered technology works at the address. Test a wired connection when available and check Wi-Fi in the rooms that matter before depending on the service for work, school, security, or smart-home devices."] },
      { heading: "7. Return old equipment when required", paragraphs: ["Follow the provider's official return or exchange instructions and retain the receipt privately. An old gateway, modem, power supply, or extender may remain tied to the account until the provider records its return."] },
      { heading: "8. Close the old account only when appropriate", paragraphs: ["If switching providers, confirm the new connection and equipment first when practical, then close the old service on the authorized date. Review the final statement for the service address, stop date, equipment, and approved charges."] },
      { heading: "Moving Xfinity or Comcast Internet", paragraphs: ["Comcast is the company name and Xfinity is its consumer-service brand. MoveIn treats Comcast/Xfinity as one provider identity and does not create duplicate comparison records.", "Use Xfinity's official moving resource to check the new address and learn whether equipment can move, self-installation is available, or a technician is needed. MoveIn does not currently publish Xfinity as a verified provider in its five-county pilot, so the official address result—not this page—determines eligibility."] },
    ],
    faqs: [
    ...
    related: ["/resources/find-internet-providers", "/resources/check-internet-availability", "/resources/when-to-transfer-utilities", "/resources/change-your-address", "/renters/internet-installation"], sources: [fcc, spectrumMoving, attMoving, tMobileMoving, verizonMoving, xfinityMoving],
  },
  {
