...
export const zipMoveOverviews: Record<string, string> = {
  ...
  "32726": "Eustis ZIP 32726 has reviewed City utility, Duke Energy, SECO Energy, Lake County, and address-level internet starting points. Two electric companies serve Eustis, while city limits, utility connections, collection eligibility, and internet still require exact-address confirmation.",
