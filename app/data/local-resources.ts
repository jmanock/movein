...
export const zipMoveOverviews: Record<string, string> = {
  ...
  "32117": "Daytona Beach ZIP 32117 is newly included in the Volusia County research tier. Use the county resources for emergency and resident information while electricity, water, sewer, and collection records are checked.",
  "32118": "Coastal ZIP 32118 includes Daytona Beach addresses where condos, rentals, and other buildings may manage services differently. The page remains noindex until the local provider set meets the pilot verification standard.",
  "32119": "Daytona Beach ZIP 32119 is not being assigned providers from neighboring ZIPs. Official Volusia County and broadband links are available now while address-specific utility evidence is gathered.",
  ...
  "32724": "DeLand ZIP 32724 is separate from the already-reviewed 32720 record and will not copy its provider assumptions. County context is available while MoveIn confirms which services apply across this mailing area.",
  ...
  "32773": "Sanford ZIP 32773 has been added as a research-stage Seminole County area. The current page intentionally limits itself to official government and broadband tools while local utility records are verified.",
  ...
  "32803": "Orlando ZIP 32803 is part of the Orange County expansion but is not yet a verified provider page. Confirm the parcel jurisdiction first because the Orlando mailing name alone cannot establish every local service.",
  "32804": "For ZIP 32804, building type and municipal boundaries can affect water, trash, and internet setup. MoveIn is retaining this Orlando-area record as noindex until each core service has official evidence.",
  "32806": "Orlando ZIP 32806 now has an official Orange County starting point and address-level broadband tools. Electric and municipal utility research is still underway, so no ZIP-wide provider claim is made.",
  "32809": "ZIP 32809 uses Orlando as its mailing city, but some addresses may follow different city or county service arrangements. Check the full address while MoveIn completes the provider and jurisdiction review.",
  "34715": "Clermont ZIP 34715 is researched independently from the verified 34711 page. This prevents provider details from being copied across a postal boundary where municipal, county, private, well, or septic arrangements may differ.",
  ...
  "34743": "Kissimmee ZIP 34743 is in the next Osceola County research group. Utility authorities, municipal limits, and collection arrangements must be checked independently before a provider list is published.",
  "34744": "For Kissimmee ZIP 34744, the county relationship is established but core provider verification is unfinished. Use the official local-government and broadband resources while the address-sensitive review proceeds.",
  "34746": "Kissimmee ZIP 34746 includes varied residential and visitor-area properties where building or community arrangements can affect service. This page stays noindex until the complete pilot checklist is met.",
  ...
  "34771": "St. Cloud ZIP 34771 covers a large Osceola County area with urban and rural service contexts. The research record points to official sources while water, sewer, electric, and collection boundaries are evaluated.",
  "34772": "St. Cloud ZIP 34772 is distinct from verified 34769 and needs its own provider evidence. Until review is finished, the page offers county context and address-level internet checks without claiming availability.",
  ...
  "34788": "Leesburg ZIP 34788 is being reviewed separately from 34748 because postal areas do not guarantee identical providers. The current county and internet links are starting points, not a service-availability claim.",
};
