...
const staticPages: PublicPage[] = [
  ...
  { path: "/resources/printables", title: "Free Moving Checklists and Printable Tools", description: "Use free, ungated moving checklists and fillable worksheets for utilities, address updates, renters, homeowners, emergency contacts, and the first 30 days.", h1: "Useful on screen. Clean on paper.", group: "resources", lastModified: "2026-08-10", changeFrequency: "monthly", priority: .78 },
  ...
  { path: "/privacy", title: "Privacy", description: "How MoveIn handles My Move browser storage, ZIP searches, coverage requests, corrections, analytics, and personal information.", h1: "Privacy", group: "trust", lastModified: "2026-08-10", changeFrequency: "yearly", priority: .25 },
