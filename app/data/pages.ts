...
const staticPages: PublicPage[] = [
  { path: "/", title: "Find Utilities and Essential Services by ZIP Code", description: "Enter a Florida ZIP code to find possible electric, water, internet, trash, and other essential service providers, then confirm your exact address.", h1: "You have the keys. Now what?", group: "main", lastModified: "2026-07-29", changeFrequency: "weekly", priority: 1 },
  { path: "/homeowners", title: "Utility Setup and Moving Resources for Homeowners", description: "Learn how to set up electricity, water, internet, trash service, outage contacts, and other essentials after moving into a new home.", h1: "Set up the essentials. Learn the house.", group: "main", lastModified: "2026-07-29", changeFrequency: "monthly", priority: .85 },
  { path: "/renters", title: "Utility Setup and Move-In Resources for Renters", description: "Learn how to confirm included utilities, open tenant accounts, arrange internet, document move-in condition, and save maintenance contacts.", h1: "Know what you set up—and what the lease covers.", group: "main", lastModified: "2026-07-29", changeFrequency: "monthly", priority: .85 },
  { path: "/learn-your-area", title: "Find Utilities and Local Services by ZIP Code", description: "Use a Florida ZIP code to find possible electric, water, sewer, internet, gas, trash, outage, city, and county information.", h1: "Learn the services connected to your ZIP.", group: "main", lastModified: "2026-07-29", changeFrequency: "monthly", priority: .85 },
  { path: "/resources", title: "Moving and Utility Setup Resources", description: "Practical guides and printable tools for utility setup, provider lookup, address changes, outages, home safety, and renter responsibilities.", h1: "Direct answers. Useful checklists. No filler.", group: "main", lastModified: "2026-07-29", changeFrequency: "monthly", priority: .8 },
  ...
  { path: "/coverage", title: "MoveIn Florida Utility Lookup Coverage", description: "See the reviewed Central Florida ZIP codes and counties currently included in MoveIn utility lookup coverage.", h1: "Small by design. Verified before it grows.", group: "main", lastModified: "2026-07-29", changeFrequency: "weekly", priority: .75 },
  ...
  { path: "/privacy", title: "Privacy", description: "How MoveIn handles ZIP searches, correction submissions, request logs, analytics, and personal information.", h1: "Privacy", group: "trust", lastModified: "2026-07-28", changeFrequency: "yearly", priority: .25 },
...
export const publicPages: PublicPage[] = [...staticPages, ...guides.map((guide) => ({ path: guide.path, title: guide.title, description: guide.description, h1: guide.h1, group: guide.section, lastModified: guide.reviewed, changeFrequency: "monthly" as const, priority: .7 })), ...printables.map((item) => ({ path: `/resources/printables/${item.slug}`, title: item.title, description: item.description, h1: item.title, group: "resources" as const, lastModified: "2026-07-29", changeFrequency: "yearly" as const, priority: .55 }))];
