...
const staticPages: PublicPage[] = [
  ...
  { path: "/resources", title: "Moving and Utility Setup Resources", description: "Practical guides and printable tools for utility setup, internet availability, provider lookup, address changes, outages, and renter responsibilities.", h1: "Direct answers. Useful checklists. No filler.", group: "main", lastModified: "2026-08-07", changeFrequency: "monthly", priority: .8 },
