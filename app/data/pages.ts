...
const staticPages: PublicPage[] = [
  ...
  { path: "/resources", title: "Moving and Utility Setup Resources", description: "Practical guides and printable tools for utility setup, provider lookup, address changes, outages, home safety, and renter responsibilities.", h1: "Direct answers. Useful checklists. No filler.", group: "main", lastModified: "2026-08-01", changeFrequency: "monthly", priority: .8 },
  ...
  { path: "/coverage", title: "MoveIn Florida Utility Lookup Coverage", description: "See verified and research-stage ZIP codes across MoveIn's five-county Central Florida utility lookup pilot.", h1: "Small by design. Verified before it grows.", group: "main", lastModified: "2026-08-03", changeFrequency: "weekly", priority: .75 },
  { path: "/florida-utilities", title: "Florida Utility Lookup and Moving Resources", description: "Browse verified utility lookup pages and moving resources for MoveIn's five Central Florida pilot counties.", h1: "Find utilities and moving resources by county.", group: "main", lastModified: "2026-08-03", changeFrequency: "weekly", priority: .8 },
...
const countyPages: PublicPage[] = countyProfiles.map((county) => ({ path: `/${county.slug}`, title: `${county.name} County Utilities and Moving Resources`, description: county.description, h1: `${county.name} County utilities and moving resources`, group: "main", lastModified: "2026-08-03", changeFrequency: "weekly", priority: .78 }));
