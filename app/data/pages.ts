...
const staticPages: PublicPage[] = [
  { path: "/", title: "Find Utilities and Essential Services by ZIP Code", description: "Enter a Florida ZIP code to find possible electric, water, internet, trash, and other essential service providers, then confirm your exact address.", h1: "Find the services for your new place.", group: "main", lastModified: "2026-07-29", changeFrequency: "weekly", priority: 1 },
  ...
  { path: "/resources", title: "Moving and Utility Setup Resources", description: "Practical guides and official tools for utility setup, provider lookup, address changes, outages, home safety, and renter responsibilities.", h1: "Useful utility and moving guidance—without the filler.", group: "main", lastModified: "2026-07-29", changeFrequency: "monthly", priority: .8 },
...
export const publicPages: PublicPage[] = [...staticPages, ...guides.map((guide) => ({ path: guide.path, title: guide.title, description: guide.description, h1: guide.h1, group: guide.section, lastModified: guide.reviewed, changeFrequency: "monthly" as const, priority: .7 }))];
